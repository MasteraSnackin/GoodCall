# GoodCall initial visual and functional audit

Historical review, 20 September 2026, before the current Claude and purchase-context follow-up. Its measurements and scores belong to that snapshot. See [the current audit](AUDIT.md).
