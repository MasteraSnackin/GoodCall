...
export interface Workspace { version: 1; questions: Question[]; products: Product[]; issues: Issue[]; drafts: Draft[]; cards: CanvasCard[]; links: CanvasLink[]; activity: Activity[] }
